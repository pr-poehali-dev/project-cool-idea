...
const categories = [
  ...
  {
    title: "Разнорабочие",
    description: "Подсобные и вспомогательные работы. Опыт не обязателен, обучение на месте.",
    icon: "HardHat",
    count: "32 вакансии",
  },
  {
    title: "Мастера / Прорабы",
    description: "Управление бригадами и проектами, контроль качества, ведение объектов под ключ.",
    icon: "ClipboardList",
    count: "10 вакансий",
  },
]
