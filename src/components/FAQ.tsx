...
const faqs = [
  {
    question: "Как найти работу через «Работа Ялта»?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Сварщики, плиточники, каменщики, штукатуры (ручная и механическая), разнорабочие, мастера и прорабы, а также другие строительные специальности. Портал специализируется исключительно на строительной сфере Ялты.",
  },
  {
    question: "Работает ли сервис в районах за пределами Ялты?",
    answer:
      "Да. Мы охватываем всю Большую Ялту: Ливадия, Массандра, Никита, Гурзуф, Алупка, Симеиз, Форос и другие прибрежные посёлки. При публикации вакансии можно указать конкретный район.",
  },
  {
