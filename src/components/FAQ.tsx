...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Все специальности: строители, сварщики, плиточники, каменщики, штукатуры, разнорабочие, мастера, прорабы и многие другие. Портал охватывает вакансии по всему Крыму.",
  },
  {
